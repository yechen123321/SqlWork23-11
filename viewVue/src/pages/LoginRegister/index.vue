...
import qs from "qs" 
import bg01 from './images/bg01.gif'
import bg02 from './images/bg02.gif'
import bg03 from './images/bg03.gif'
import bg04 from './images/bg04.gif'
export default {
    name: "LoginRegister",
    data(){
        return{
...
.link:hover{
    color: #0393a3;
    border-bottom: #0393a3 1px solid;
}
